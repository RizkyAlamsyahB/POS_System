    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Promosi</h3>
                <p class="text-subtitle text-muted">Ubah data promosi</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Form Edit Promosi: <strong><?= esc($promotion['name']) ?></strong></h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select <?= isset($errors['discount_type']) ? 'is-invalid' : '' ?>" 
                                    ...
                                    <option value="fixed_amount" <?= old('discount_type', $promotion['discount_type']) == 'fixed_amount' ? 'selected' : '' ?>>Nominal (Rp)</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" 
                                       id="min_purchase" name="min_purchase" value="<?= old('min_purchase', $promotion['min_purchase']) ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="outlet_id" name="outlet_id">
                                    ...
                                    <?php foreach ($outlets as $outlet): ?>
                                        <option value="<?= $outlet['id'] ?>" <?= old('outlet_id', $promotion['outlet_id']) == $outlet['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control <?= isset($errors['start_date']) ? 'is-invalid' : '' ?>" 
                                       id="start_date" name="start_date" value="<?= old('start_date', $promotion['start_date']) ?>" required>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="start_time" name="start_time" value="<?= old('start_time', $promotion['start_time']) ?>">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="end_time" name="end_time" value="<?= old('end_time', $promotion['end_time']) ?>">
                                <small class="text-muted">Opsional</small>
                            </div>
                        </div>
                    </div>
