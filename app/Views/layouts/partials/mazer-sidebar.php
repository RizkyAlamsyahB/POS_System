...
<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item <?= str_contains($currentUrl, 'admin/settings') ? 'active' : '' ?>">
            ...
            <li class="sidebar-item <?= str_contains($currentUrl, 'manager/inventory') ? 'active' : '' ?>">
                <a href="/manager/inventory" class='sidebar-link'>
                    <i class="bi bi-inbox-fill"></i>
                    <span>Stock Management</span>
                </a>
            </li>
            
            <li class="sidebar-item <?= str_contains($currentUrl, 'manager/promotions') ? 'active' : '' ?>">
                <a href="/manager/promotions" class='sidebar-link'>
                    <i class="bi bi-percent"></i>
                    <span>Promotions</span>
                </a>
            </li>
